...
# export COMPUTE_ENGINE_NODE=${m3_nodes[2]}
...
# write_variable_to_file "COMPUTE_ENGINE_NODE" "$COMPUTE_ENGINE_NODE"
...
# printf "%-50s %s\n" "DataStereamPilot: COMPUTE_ENGINE_NODE:" "m3 - $COMPUTE_ENGINE_NODE"
