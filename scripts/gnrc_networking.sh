...
if [ -n "$IOT_LAB_FRONTEND_FQDN" ]; then
  ...
  cp ${GNRC_NETWORKING_HOME}/bin/iotlab-a8-m3/${GNRC_NETWORKING_EXE_NAME}.elf ${SENSE_FIRMWARE_HOME}
  cp ${GNRC_NETWORKING_HOME}/bin/iotlab-a8-m3/${GNRC_NETWORKING_EXE_NAME}.elf ~/A8
